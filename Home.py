...
# Reemplazar "www.urbex.com.co" por "localhost:8501" o al reves en los archivos donde esta la palabra
# Get-ChildItem -Path D:\Dropbox\Empresa\Urbex\_APP_heroku -Recurse -Filter *.py | ForEach-Object {(Get-Content $_.FullName) | ForEach-Object {$_ -replace 'www.urbex.com.co', 'localhost:8501'} | Set-Content $_.FullName}
