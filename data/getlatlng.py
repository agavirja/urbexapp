...
def getlatlng(direccion):
    latitud,longitud = getlatlngfromcatastro(direccion)
...
def getlatlngfromcatastro(direccion):
    ...
    if isinstance(direccion, str):
        ...
        data    = pd.read_sql_query(f"SELECT latitud,longitud FROM bigdata.data_bogota_catastro WHERE coddir='{fcoddir}'" , engine)
        engine.dispose()
